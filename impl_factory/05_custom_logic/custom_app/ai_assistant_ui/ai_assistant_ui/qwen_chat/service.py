...
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.audit_support
_audit_latency_summary_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.audit_support", "audit_latency_summary")
_case_latency_budget_assessment_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.audit_support", "case_latency_budget_assessment")
_family_latency_budget_payload_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.audit_support", "family_latency_budget_payload")
_family_latency_budget_summary_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.audit_support", "family_latency_budget_summary")
_family_metrics_summary_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.audit_support", "family_metrics_summary")
...
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.snapshot_defaults
_build_active_sequence_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_active_sequence_snapshot_state")
_build_historical_recent_focus_snapshot_inputs_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_historical_recent_focus_snapshot_inputs")
_build_latest_artifact_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_latest_artifact_snapshot_state")
_build_latest_grounded_turn_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_latest_grounded_turn_snapshot_state")
_build_latest_recovery_contract_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_latest_recovery_contract_snapshot_state")
_build_latest_repair_intent_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_latest_repair_intent_snapshot_state")
_build_pending_clarification_snapshot_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_pending_clarification_snapshot_state")
_build_snapshot_internal_details_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_snapshot_internal_details")
_build_snapshot_state_quality_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "build_snapshot_state_quality")
_empty_resumable_prior_request_state_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.snapshot_defaults", "empty_resumable_prior_request_state")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.smoke_fixtures
require_smoke_fixture = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_fixtures", "require_smoke_fixture")
smoke_fixture_action_message = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_fixtures", "smoke_fixture_action_message")
smoke_fixture_reasoning_message = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_fixtures", "smoke_fixture_reasoning_message")
smoke_fixture_replacement_message = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_fixtures", "smoke_fixture_replacement_message")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.family_evaluation_support
_build_family_latency_budget_report_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "build_family_latency_budget_report")
_run_clarification_policy_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_clarification_policy_smoke")
_run_clarification_translation_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_clarification_translation_probe")
_run_context_isolation_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_context_isolation_smoke")
_run_entity_drilldown_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_entity_drilldown_probe")
_run_entity_drilldown_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_entity_drilldown_smoke")
_run_family_evaluation_case_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_evaluation_case")
_run_family_evaluation_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_evaluation_smoke")
_run_family_latency_budget_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_latency_budget_smoke")
_run_followup_fidelity_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_followup_fidelity_smoke")
_run_full_family_evaluation_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_full_family_evaluation_suite")
_run_full_family_evaluation_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_full_family_evaluation_smoke")
_run_family_evaluation_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_evaluation_suite")
_run_followup_report_ambiguity_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_followup_report_ambiguity_smoke")
_run_family_tool_surface_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_tool_surface_probe")
_run_family_tool_surface_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_family_tool_surface_smoke")
_run_natural_narrative_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_natural_narrative_smoke")
_run_response_policy_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_response_policy_probe")
_run_delivery_note_date_scope_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_date_scope_probe")
_run_delivery_note_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_detail_smoke")
_run_delivery_note_listing_limit_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_listing_limit_probe")
_run_delivery_note_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_listing_smoke")
_run_delivery_note_session_reset_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_session_reset_smoke")
_run_delivery_note_status_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_status_probe")
_run_delivery_note_trend_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_delivery_note_trend_probe")
_run_fresh_chat_invoice_delivery_proof_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_fresh_chat_invoice_delivery_proof_smoke")
_run_invoice_delivery_proof_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_invoice_delivery_proof_smoke")
_run_customer_credit_exposure_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_exposure_smoke")
_run_customer_credit_overdue_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_overdue_smoke")
_run_customer_credit_balance_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_balance_smoke")
_run_customer_credit_detail_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_detail_followup_smoke")
_run_customer_detail_clarification_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_detail_clarification_followup_smoke")
_run_customer_credit_policy_followup_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_policy_followup_probe")
_run_customer_credit_policy_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_policy_followup_smoke")
_run_governed_customer_commercial_composite_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_governed_customer_commercial_composite_smoke")
_run_governed_kpi_frontdoor_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_governed_kpi_frontdoor_smoke")
_run_governed_kpi_customer_execution_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_governed_kpi_customer_execution_smoke")
_run_governed_kpi_period_execution_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_governed_kpi_period_execution_smoke")
_run_customer_credit_overdue_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_overdue_probe")
_run_customer_credit_balance_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_balance_probe")
_run_customer_credit_scope_reset_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_scope_reset_probe")
_run_customer_credit_scope_reset_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_customer_credit_scope_reset_smoke")
_run_purchase_order_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_purchase_order_detail_smoke")
_run_purchase_order_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_purchase_order_listing_smoke")
_run_purchase_order_status_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_purchase_order_status_followup_smoke")
_run_purchase_order_status_scope_reset_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_purchase_order_status_scope_reset_smoke")
_run_sales_order_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_sales_order_detail_smoke")
_run_sales_order_status_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_sales_order_status_followup_smoke")
_run_structured_presentation_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_structured_presentation_smoke")
_run_transaction_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.family_evaluation_support", "run_transaction_listing_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.phase55_hardening_support
_run_phase55_ap_ar_default_policy_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_ap_ar_default_policy_smoke")
_run_phase55_clarification_attempt_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_clarification_attempt_smoke")
_run_phase55_clarification_meta_question_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_clarification_meta_question_smoke")
_run_phase55_frontdoor_boundary_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_frontdoor_boundary_smoke")
_run_phase55_hardening_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_hardening_suite")
_run_phase55_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_observability_smoke")
_run_phase55_pending_override_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase55_hardening_support", "run_pending_override_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.phase6_hardening_support
_run_phase6_artifact_refinement_precedence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_artifact_refinement_precedence_smoke")
_run_phase6_continuation_fulfillment_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_continuation_fulfillment_smoke")
_run_phase6_grounded_source_reset_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_grounded_source_reset_smoke")
_run_phase6_hardening_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_hardening_suite")
_run_phase6_nonadvisory_recommendation_boundary_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_nonadvisory_recommendation_boundary_smoke")
_run_phase6_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_observability_smoke")
_run_phase6_reasoning_frontdoor_boundary_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_reasoning_frontdoor_boundary_smoke")
_run_phase6_reasoning_live_rollout_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_reasoning_live_rollout_smoke")
_run_phase6_reasoning_without_grounding_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase6_hardening_support", "run_reasoning_without_grounding_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.phase7_hardening_support
_run_phase7_boundary_response_live_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase7_hardening_support", "run_boundary_response_live_smoke")
_run_phase7_hardening_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase7_hardening_support", "run_hardening_suite")
_run_phase7_live_boundary_orchestration_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase7_hardening_support", "run_live_boundary_orchestration_smoke")
_run_phase7_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase7_hardening_support", "run_observability_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.phase8_hardening_support
_run_phase8_evidence_boundary_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_evidence_boundary_observability_smoke")
_run_phase8_enrichment_boundary_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_enrichment_boundary_observability_smoke")
_run_phase8_fresh_query_override_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_fresh_query_override_smoke")
_run_phase8_hardening_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_hardening_suite")
_run_phase8_recovery_authority_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_recovery_authority_smoke")
_run_phase8_recovery_execution_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_recovery_execution_smoke")
_run_phase8_recovery_guidance_observability_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_recovery_guidance_observability_smoke")
_run_phase8_repair_handling_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.phase8_hardening_support", "run_repair_handling_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.smoke_session_support
_run_phase55_smoke_session_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_session_support", "run_phase55_smoke_session")
_run_phase6_smoke_session_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.smoke_session_support", "run_phase6_smoke_session")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes
_ScopePackageSmokeDependencies = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "ScopePackageSmokeDependencies")
_run_phase_e1_4_item_master_activation_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e1_4_item_master_activation_smoke")
_run_phase_e1_5_item_deictic_continuity_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e1_5_item_deictic_continuity_smoke")
_run_phase_e1_6_item_inventory_followup_debug_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e1_6_item_inventory_followup_debug_smoke")
_run_phase_e2_1b_purchase_invoice_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e2_1b_purchase_invoice_listing_smoke")
_run_phase_e2_4_purchase_receipt_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e2_4_purchase_receipt_listing_smoke")
_run_phase_e3_2_payment_entry_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.scope_package_smokes", "run_phase_e3_2_payment_entry_listing_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes
_ConversationControlSmokeDependencies = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "ConversationControlSmokeDependencies")
_run_h3_branch_restore_prefers_newer_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_branch_restore_prefers_newer_focus_smoke")
_run_h3_branch_restore_prefers_recent_focus_over_historical_prior_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_branch_restore_prefers_recent_focus_over_historical_prior_focus_smoke")
_run_h3_clarification_preempts_recovery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_clarification_preempts_recovery_smoke")
_run_h3_clarification_resolution_does_not_resurrect_stale_recovery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_clarification_resolution_does_not_resurrect_stale_recovery_smoke")
_run_h3_discard_prefixed_branch_restore_prefers_newer_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_branch_restore_prefers_newer_focus_smoke")
_run_h3_discard_prefixed_question_restore_resumes_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_question_restore_resumes_active_sequence_smoke")
_run_h3_active_sequence_override_clears_prior_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_active_sequence_override_clears_prior_sequence_smoke")
_run_h3_ambiguous_item_list_to_stock_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_ambiguous_item_list_to_stock_followup_smoke")
_run_h3_discard_prefixed_targeted_restore_recovers_historical_branch_over_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_recovers_historical_branch_over_active_sequence_smoke")
_run_h3_exact_item_focus_stock_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_exact_item_focus_stock_followup_smoke")
_run_h3_discard_prefixed_branch_restore_prefers_recent_focus_over_historical_prior_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_branch_restore_prefers_recent_focus_over_historical_prior_focus_smoke")
_run_h3_discard_prefixed_targeted_restore_replays_resumable_prior_recovery_over_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_replays_resumable_prior_recovery_over_active_sequence_smoke")
_run_h3_discard_prefixed_targeted_restore_replays_resumable_prior_recovery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_replays_resumable_prior_recovery_smoke")
_run_h3_discard_prefixed_targeted_restore_prefers_purchase_order_listing_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_prefers_purchase_order_listing_over_newer_detail_smoke")
_run_h3_discard_prefixed_targeted_restore_prefers_sales_invoice_listing_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_prefers_sales_invoice_listing_over_newer_detail_smoke")
_run_h3_discard_prefixed_targeted_restore_recovers_sales_invoice_listing_over_newer_purchase_order_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_recovers_sales_invoice_listing_over_newer_purchase_order_listing_smoke")
_run_h3_duplicate_acceptance_after_newer_recovery_execution_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_duplicate_acceptance_after_newer_recovery_execution_smoke")
_run_h4_adversarial_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_adversarial_suite")
_run_h4_creative_followup_after_reasoning_is_refused_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_creative_followup_after_reasoning_is_refused_smoke")
_run_h4_inferred_operational_evidence_stays_bounded_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_inferred_operational_evidence_stays_bounded_smoke")
_run_h4_long_multisentence_followup_stays_bounded_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_long_multisentence_followup_stays_bounded_smoke")
_run_h4_mixed_metric_request_stays_bounded_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_mixed_metric_request_stays_bounded_smoke")
_run_h4_recommendation_guarantee_stays_bounded_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h4_recommendation_guarantee_stays_bounded_smoke")
_run_h5_release_gate_rollout_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h5_release_gate_rollout_probe")
_run_h5_release_gate_sanity_pack_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h5_release_gate_sanity_pack")
_run_h5_release_gate_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h5_release_gate_suite")
_run_h3_targeted_restore_prefers_collection_branch_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_collection_branch_over_newer_detail_smoke")
_run_h3_targeted_restore_prefers_customer_collection_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_customer_collection_over_newer_detail_smoke")
_run_h3_latest_seeded_recovery_wins_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_latest_seeded_recovery_wins_smoke")
_run_h3_latest_fresh_grounded_query_wins_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_latest_fresh_grounded_query_wins_smoke")
_run_h3_targeted_restore_prefers_named_branch_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_named_branch_smoke")
_run_h3_newer_recovery_survives_older_consumed_recovery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_newer_recovery_survives_older_consumed_recovery_smoke")
_run_h3_option_list_that_you_found_to_stock_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_option_list_that_you_found_to_stock_followup_smoke")
_run_h3_option_list_then_override_switches_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_option_list_then_override_switches_focus_smoke")
_run_h3_pending_discard_redirects_to_balance_sheet_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_pending_discard_redirects_to_balance_sheet_smoke")
_run_h3_pending_discard_redirects_to_fresh_supplier_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_pending_discard_redirects_to_fresh_supplier_focus_smoke")
_run_post_contract_regression_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_post_contract_regression_suite")
_run_h3_question_restore_reopens_pending_clarification_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_question_restore_reopens_pending_clarification_smoke")
_run_h3_repeated_identical_composite_grounded_query_replaces_grounding_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_repeated_identical_composite_grounded_query_replaces_grounding_smoke")
_run_h3_repeated_identical_fresh_query_replaces_grounding_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_repeated_identical_fresh_query_replaces_grounding_smoke")
_run_h3_soft_chained_pending_redirect_to_fresh_supplier_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_soft_chained_pending_redirect_to_fresh_supplier_focus_smoke")
_run_h3_targeted_restore_prefers_purchase_order_listing_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_purchase_order_listing_over_newer_detail_smoke")
_run_h3_targeted_restore_replays_resumable_prior_recovery_over_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_replays_resumable_prior_recovery_over_active_sequence_smoke")
_run_h3_targeted_restore_replays_resumable_prior_recovery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_replays_resumable_prior_recovery_smoke")
_run_h3_targeted_restore_recovers_sales_invoice_listing_over_newer_purchase_order_listing_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_recovers_sales_invoice_listing_over_newer_purchase_order_listing_smoke")
_run_h3_branch_restore_reopens_pending_clarification_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_branch_restore_reopens_pending_clarification_smoke")
_run_h3_financial_statement_switch_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_financial_statement_switch_followup_smoke")
_run_h3_master_data_single_row_detail_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_master_data_single_row_detail_followup_smoke")
_run_h3_pronoun_discard_question_restore_resumes_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_pronoun_discard_question_restore_resumes_active_sequence_smoke")
_run_h3_pronoun_discard_targeted_restore_over_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_pronoun_discard_targeted_restore_over_active_sequence_smoke")
_run_h3_question_restore_resumes_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_question_restore_resumes_active_sequence_smoke")
_run_h3_targeted_restore_recovers_historical_branch_over_active_sequence_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_recovers_historical_branch_over_active_sequence_smoke")
_run_h3_targeted_restore_prefers_sales_invoice_listing_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_sales_invoice_listing_over_newer_detail_smoke")
_run_h3_targeted_restore_prefers_item_collection_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_targeted_restore_prefers_item_collection_over_newer_detail_smoke")
_run_h3_seeded_transaction_document_followup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_seeded_transaction_document_followup_smoke")
_run_h3_discard_prefixed_targeted_restore_prefers_item_collection_over_newer_detail_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_discard_prefixed_targeted_restore_prefers_item_collection_over_newer_detail_smoke")
_run_h3_duplicate_recovery_acceptance_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_duplicate_recovery_acceptance_smoke")
_run_h3_fresh_query_replaces_grounded_context_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_fresh_query_replaces_grounded_context_smoke")
_run_h3_master_data_pending_override_switches_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_master_data_pending_override_switches_focus_smoke")
_run_h3_pending_override_replaces_with_new_grounded_context_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_pending_override_replaces_with_new_grounded_context_smoke")
_run_h3_post_stop_clarification_repeat_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_post_stop_clarification_repeat_smoke")
_run_h3_question_restore_prefers_newer_focus_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_question_restore_prefers_newer_focus_smoke")
_run_h3_stale_recovery_invalidated_by_fresh_override_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.conversation_control_smokes", "run_h3_stale_recovery_invalidated_by_fresh_override_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.evaluation.bounded_release_gate
_bounded_release_gate_inventory_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.bounded_release_gate", "bounded_release_gate_inventory")
_run_bounded_release_gate_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.bounded_release_gate", "run_bounded_release_gate")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.evaluation.nbu_governed_requery_smoke
_run_nbu_governed_requery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.nbu_governed_requery_smoke", "run_nbu_governed_requery_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.evaluation.nbu_s7_regression_matrix_smoke
_run_nbu_s7_same_session_fresh_query_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.nbu_s7_regression_matrix_smoke", "run_nbu_s7_same_session_fresh_query_smoke")
_run_nbu_s7_safe_boundary_language_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.nbu_s7_regression_matrix_smoke", "run_nbu_s7_safe_boundary_language_smoke")
_run_nbu_s7_visible_context_latest_artifact_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.evaluation.nbu_s7_regression_matrix_smoke", "run_nbu_s7_visible_context_latest_artifact_smoke")
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.probes.service_diagnostics
_run_first_turn_regression_suite_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_first_turn_regression_suite")
_run_phase1_1_delivery_note_invoice_switch_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase1_1_delivery_note_invoice_switch_debug")
_run_phase1_1_invoice_detail_delivery_trend_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase1_1_invoice_detail_delivery_trend_debug")
_run_phase3_2_projection_followup_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase3_2_projection_followup_debug")
_run_phase3_2_subject_switch_regression_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase3_2_subject_switch_regression_debug")
_run_phase3_3c_customer_master_lookup_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase3_3c_customer_master_lookup_smoke")
_run_phase_d2a_transaction_listing_today_requery_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase_d2a_transaction_listing_today_requery_smoke")
_run_phase_d2c_transaction_listing_base_scope_reset_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase_d2c_transaction_listing_base_scope_reset_smoke")
_run_phase3_3_product_quantity_projection_regression_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase3_3_product_quantity_projection_regression_debug")
_run_phase3_3_ranking_projection_continuation_regression_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase3_3_ranking_projection_continuation_regression_debug")
_run_phase4_compiled_rollout_governance_selftests_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase4_compiled_rollout_governance_selftests")
_run_phase4_compiled_rollout_monitoring_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase4_compiled_rollout_monitoring_smoke")
_run_phase4_compiled_rollout_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase4_compiled_rollout_smoke")
_run_phase6_reasoning_live_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase6_reasoning_live_debug")
_run_phase8_recovery_execution_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase8_recovery_execution_debug")
_run_phase8c_repair_handling_debug_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_phase8c_repair_handling_debug")
_run_same_session_fresh_query_regression_smoke_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "run_same_session_fresh_query_regression_smoke")
_summarize_compiled_first_turn_audits_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.probes.service_diagnostics", "summarize_compiled_first_turn_audits")
...
# Deferred optional helper imports: ai_assistant_ui.qwen_chat.governed_kpi_support
_run_governed_kpi_frontdoor_probe_helper = _lazy_symbol("ai_assistant_ui.qwen_chat.governed_kpi_support", "run_governed_kpi_frontdoor_probe")
...
def _service_policy_boundary_metadata_envelope(*, answer_mode: str) -> Dict[str, Any]:
	return build_runtime_metadata_envelope(
		lane_id="service_policy_control_responses",
		...
		answer_mode=str(answer_mode or "").strip() or "service_policy_boundary",
		preflight_status="bounded",
		metadata_source="service_policy_control_authorized_emission",
	)



def _service_control_metadata_envelope(*, answer_mode: str, authority: Dict[str, Any]) -> Dict[str, Any]:
	authority_source = str((authority or {}).get("authority_source") or "").strip()
	return build_runtime_metadata_envelope(
		lane_id="service_policy_control_responses",
		...
		evidence_scope="service_control_contract",
		answer_mode=str(answer_mode or "").strip() or "service_control_answer",
		preflight_status=str((authority or {}).get("preflight_status") or "passed").strip() or "passed",
		metadata_source="service_policy_control_authorized_emission",
	)
...
def _emit_service_policy_boundary_answer(
	*,
	...
	runtime_metadata_envelope = _service_policy_boundary_metadata_envelope(answer_mode=mode)
...
def _emit_service_control_answer(
	*,
	...
	runtime_metadata_envelope = _service_control_metadata_envelope(answer_mode=answer_mode, authority=authority)
	return emit_authorized_assistant_answer(
		session_doc=session_doc,
		answer_text=answer_text,
		...
		pre_assistant_tool_payloads=[
			*_service_tool_payload_values(pre_assistant_payload_values),
			runtime_metadata_envelope,
		],
	)
