...
- Warehouse Console W11/W11A/W11B/W13A is docs-only; Purchase Receipt receiving design is accepted only as a design package, W12A-W12K completed read-only structure polish, and the next selected direction is W13 visual harmonization. No Warehouse execution implementation phase should start until Main Control and the owner explicitly approve a scoped implementation after Security/Stability and Operation Reviewer acceptance.
