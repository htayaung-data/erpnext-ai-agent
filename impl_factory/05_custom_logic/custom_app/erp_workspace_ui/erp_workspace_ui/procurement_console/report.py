...
def _comparison_controls(filters: dict[str, object]) -> dict[str, object]:
	return {
		...
		"fields": [
			...
			{"key": "item_code", "label": "Item", "type": "link", "linkDoctype": "Item", "value": filters.get("item_code"), "row": 2},
			{"key": "supplier", "label": "Supplier", "type": "link", "linkDoctype": "Supplier", "value": filters.get("supplier"), "row": 2},
			{"key": "supplier_quotation", "label": "Quotation", "type": "link", "linkDoctype": "Supplier Quotation", "value": filters.get("supplier_quotation"), "row": 2},
			{"key": "request_for_quotation", "label": "RFQ", "type": "link", "linkDoctype": "Request for Quotation", "value": filters.get("request_for_quotation"), "row": 2},
			{
				"key": "include_expired",
				"label": "Expired",
				"type": "select",
