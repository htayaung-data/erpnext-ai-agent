...
ACTION_MANIFEST: tuple[dict[str, Any], ...] = (
	...
	_action("procurement-managed-pr-open-native", "procurement", "procurement-console-purchase-request-form/<material-request>", "open_erp_form", "governed_native_action", "form", label="Open ERP Form", native_exception_ref="procurement-secondary-native-open-v1", notes="Secondary governed native access only after a draft exists."),
	...
	_action("procurement-managed-rfq-open-native", "procurement", "procurement-console-rfq-form/<rfq>", "open_erp_form", "governed_native_action", "form", label="Open ERP Form", native_exception_ref="procurement-secondary-native-open-v1", notes="Secondary governed native access only after a draft exists."),
	...
	_action("procurement-managed-rfq-email-blocked", "procurement", "procurement-console-rfq-form/<rfq>", "send_rfq", "productized_secondary_action", "disabled", label="Send RFQ", notes="Phase 6C2A blocked action; governed RFQ send remains deferred and non-actionable when test SMTP is unavailable."),
	_action("procurement-managed-rfq-test-send", "procurement", "procurement-console-rfq-form/<rfq>", "send_rfq_test_email", "productized_secondary_action", "controlled_email_test_endpoint", label="Send RFQ", notes="Phase 6C2C controlled single-recipient RFQ test/demo send wrapper. Requires Purchase Manager, backend SMTP env, explicit confirmation, and test recipient override; no native RFQ send, Contact/User, Communication, Email Queue, submit, portal, or conversion side effects."),
	...
	_action("procurement-rfq-review-email-blocked", "procurement", "procurement-console-rfq-review/<rfq>", "send_rfq", "productized_secondary_action", "disabled", label="Send RFQ", notes="Phase 6C2A blocked action on RFQ Review; governed RFQ send remains deferred and non-actionable when test SMTP is unavailable."),
	_action("procurement-rfq-review-test-send", "procurement", "procurement-console-rfq-review/<rfq>", "send_rfq_test_email", "productized_secondary_action", "controlled_email_test_endpoint", label="Send RFQ", notes="Phase 6C2C controlled single-recipient RFQ test/demo send wrapper from RFQ Review. Requires Purchase Manager, backend SMTP env, explicit confirmation, and test recipient override; no native RFQ send, Contact/User, Communication, Email Queue, submit, portal, or conversion side effects."),
	...
	_action("procurement-managed-sq-open-native", "procurement", "procurement-console-supplier-quotation-form/<supplier-quotation>", "open_erp_form", "governed_native_action", "form", label="Open ERP Form", native_exception_ref="procurement-secondary-native-open-v1", notes="Secondary governed native access only after a draft exists."),
	...
	_action("procurement-managed-po-open-native", "procurement", "procurement-console-purchase-order-form/<purchase-order>", "open_erp_form", "governed_native_action", "form", label="Open ERP Form", native_exception_ref="procurement-secondary-native-open-v1", notes="Secondary governed native access only after a draft exists."),
