...
ACTION_MANIFEST: tuple[dict[str, Any], ...] = (
	...
	_action("procurement-managed-rfq-email-blocked", "procurement", "procurement-console-rfq-form/<rfq>", "email_suppliers", "productized_secondary_action", "disabled", label="Email suppliers", notes="Phase 6C1 blocked action; governed RFQ send remains deferred."),
