...
ACTION_MANIFEST: tuple[dict[str, Any], ...] = (
	...
	_action("procurement-report-index-open-quote-comparison", "procurement", "procurement-console-report", "open_supplier_quotation_comparison", "productized_navigation", "report_page", label="Quote Comparison", target_route_pattern="/desk/procurement-console-report/supplier-quotation-comparison", notes="Ready Reports Index card opens the productized Quote Comparison wrapper; planned report cards remain disabled."),
