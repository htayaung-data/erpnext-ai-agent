...
(function () {
  ...
  function ensureProcurementReportCatalogStyle() {
    ...
    style.textContent = [
      ...
      '.erpw-procurement-report-card { position:relative; min-height:146px; padding:13px 15px 13px; border-radius:15px; border:1px solid #dbe6f2; background:#ffffff; display:flex; flex-direction:column; gap:8px; text-align:left; color:#0f172a; box-shadow:0 8px 20px rgba(15,23,42,0.034); transition:border-color 140ms ease, box-shadow 140ms ease, transform 140ms ease; }',
      ...
      '.erpw-procurement-report-card-title { font-size:15.25px; line-height:1.2; font-weight:760; color:#0f172a; word-spacing:0.18em; }',
