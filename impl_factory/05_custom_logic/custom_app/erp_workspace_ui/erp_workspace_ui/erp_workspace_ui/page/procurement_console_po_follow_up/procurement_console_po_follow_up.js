...
(function () {
  ...
  function mountPayload(viewState, payload) {
    ...
    const renderer = shellContent().renderShellContent;
    if (typeof renderer !== "function") {
      viewState.$shell.html('<section class="erpw-child-card"><div class="erpw-list-state error"><div class="erpw-list-state-title">Detail runtime unavailable</div><div class="erpw-list-state-detail">Shared child-page runtime is not loaded.</div></div></section>');
      return;
    }
    renderer(viewState.$shell, {
