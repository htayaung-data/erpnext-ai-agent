...
(function () {
  const PAGE_KEY = "procurement-console-purchase-request-form";
  const FORM_PAGE_ASSET = "/assets/erp_workspace_ui/js/procurement_console/procurement_console_purchase_request_form.js";

  function withFormRuntime(wrapper, methodName) {
    frappe.require(FORM_PAGE_ASSET, () => {
      const runtime = window.erpWorkspaceUiProcurementPurchaseRequestForm || {};
