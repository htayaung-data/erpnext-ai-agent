...
async function checkSupplierAutocomplete(page) {
  ...
  assertTextSearchField(supplierPayload, "keyword", "Supplier Directory", "Search supplier or group", "Search supplier or group");
  assertLinkField(requestPayload, "material_request", "Material Request", "Purchase Requests", "Select purchase request");
  assertTextSearchField(requestPayload, "keyword", "Purchase Requests", "Search request, item, or warehouse");
  ...
  assertTextSearchField(orderPayload, "keyword", "Purchase Orders", "Search order, supplier, or item");
  ...
  assertTextSearchField(followUpPayload, "keyword", "PO Follow-up", "Search order, supplier, or item");
  ...
  assertTextSearchField(rfqPayload, "keyword", "RFQs", "Search RFQ, supplier, or item");
  ...
  assertTextSearchField(quotationPayload, "keyword", "Supplier Quotations", "Search quotation, supplier, or item");
  assertNoCompanyField(quotationPayload, "Supplier Quotations");
  assertLinkField(itemPayload, "item", "Item", "Buying Items", "Select item");
  assertTextSearchField(itemPayload, "keyword", "Buying Items", "Search item, name, or group");
