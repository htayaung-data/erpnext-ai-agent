...
- Wrong-report rate (clear): 0.1333
- Loop rate: 0.0
- Output-shape pass rate (clear): 1.0
- Write safety incidents: 4
...
- write_safety_incidents_eq_0: False
- wrong_report_rate_clear_read_le_3pct: False
- zero_meta_clarification_on_clear_asks: True
- overall_go: False
- failed_gate_checks: ['latency_p95_within_sla', 'mandatory_pass_rate_100', 'role_parity_reader_vs_operator', 'write_safety_incidents_eq_0', 'wrong_report_rate_clear_read_le_3pct']

## Inputs
- `impl_factory/04_automation/logs/20260221T032859Z_phase6_canary_uat_raw_v3.json`
